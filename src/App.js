...
function App() {
  ...
  <div>
    ...
    <Routes>
      ...
      <Route path='/list' element={ <ListMovies setTitre={setTitre} setEtoile={setEtoile} movies={movies} setMovies={setMovies} titre={titre} etoile={etoile}/>}/>
